...
inline TaskDescription describe(QueueIndex ix, void (*fn)(Context *, FnArgs...), PassedArgs... args) {
  ...
  std::function<TaskSig> bound_fn = std::bind(fn, std::placeholders::_1, args...);
