...
const uint32_t WIDTH = PROBE_GRID_SIZE.x * PROBE_GRID_SIZE_Z_FACTORS.x * 6; // :OctomapSize
const uint32_t HEIGHT = PROBE_GRID_SIZE.y * PROBE_GRID_SIZE_Z_FACTORS.y * 6; // :OctomapSize
