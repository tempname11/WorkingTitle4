...
const auto PROBE_WORLD_DELTA = glm::vec3(1.0);
const auto PROBE_GRID_SIZE = glm::uvec3(32, 32, 16);
const auto PROBE_GRID_SIZE_Z_FACTORS = glm::uvec2(4, 4);
const auto PROBE_RAY_COUNT = 64; // :DDGI_N_Rays
