...
constexpr auto PROBE_WORLD_DELTA = glm::vec3(1.0);

constexpr auto PROBE_GRID_SIZE_Z_FACTORS = glm::uvec2(4, 4);
constexpr auto PROBE_GRID_SIZE = glm::uvec3(16, 16, 16);
static_assert(PROBE_GRID_SIZE.z == PROBE_GRID_SIZE_Z_FACTORS.x * PROBE_GRID_SIZE_Z_FACTORS.y);

constexpr auto PROBE_RAY_COUNT = 64; // :GI_N_Rays
constexpr auto PROBE_RAY_COUNT_FACTORS = glm::uvec2(8, 8);
static_assert(PROBE_RAY_COUNT == PROBE_RAY_COUNT_FACTORS.x * PROBE_RAY_COUNT_FACTORS.y);
